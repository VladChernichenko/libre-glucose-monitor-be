 ...
 * starts Spring with {@code experiments-enabled=true}).
 */
...
class ExperimentFeatureFlagOffE2ETest {
    ...
    private HttpHeaders registerAndLogin() {
        ...
        reg.setUsername("flagoff_" + suffix);
        reg.setEmail("flagoff+" + suffix + "@example.com");
        reg.setFullName("FlagOff User");
