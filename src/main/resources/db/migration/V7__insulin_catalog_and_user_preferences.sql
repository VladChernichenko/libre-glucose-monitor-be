...
('FIASP', 'RAPID', 'Fiasp (faster aspart)', 55, 4.5, 52, 7,
 'Ultra-rapid bolus: OpenAPS-style exponential IOB (peak ~55 min, DIA ~4.5 h). Elimination half-life order of magnitude ~50–60 min (approx.).'),
('APRIDRA', 'RAPID', 'Apidra (insulin glulisine)', 75, 4.0, 45, 20,
 'Rapid bolus: OpenAPS rapid-acting peak 75 min, DIA ~4 h. Glulisine half-life commonly cited ~40–50 min (approx.).'),
