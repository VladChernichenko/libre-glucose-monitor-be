...
-- Each row is one (user_id, meal_window) pair — at most 3 rows per user
-- (BREAKFAST, LUNCH, DINNER). Night hours (22:00–04:59) are intentionally skipped.
...
CREATE TABLE IF NOT EXISTS isf_meal_window_snapshots (
    ...
    CONSTRAINT chk_isf_meal_window     CHECK (meal_window IN ('BREAKFAST','LUNCH','DINNER')),
